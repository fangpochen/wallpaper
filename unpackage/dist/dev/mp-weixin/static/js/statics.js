...
export const statics = {
	...
	tougao:config.staticUrl + 'tougao.png',
	...
	shizs:config.staticUrl + 'shizs.png',
	...
	zsyioc:[
		config.staticUrl + 'xiazaiion.png',//下载
		config.staticUrl + 'fenm.png',//封面
		config.staticUrl + 'jfen.png',//积分
		config.staticUrl + 'kefusa.png',//客服
	],
	integralRoleImg:[
